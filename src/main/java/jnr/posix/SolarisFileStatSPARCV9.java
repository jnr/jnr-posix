...
public class SolarisFileStatSPARCV9 extends BaseFileStat implements NanosecondFileStat {
    ...
    public SolarisFileStatSPARCV9() {
        this(null);
    }
    public SolarisFileStatSPARCV9(NativePOSIX posix) {
        super(posix, layout);
    }
